...
For example:
   ...
   $ sudo twistcli sandbox --address https://<console-address>:8083 --token 'your-api-token' --analysis-duration 2m <image name>
...
To view the reults in the Console UI, navigate to Monitor -> Runtime -> and click the "Image Analysis Sandbox" tab:
